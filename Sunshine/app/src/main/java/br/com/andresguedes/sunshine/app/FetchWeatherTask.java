...
import br.com.andresguedes.sunshine.app.data.WeatherContract;
import br.com.andresguedes.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = preferences.getString("units", "metric");
    ...
    protected String[] doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 14;
        String apiId = "591c0540f97869e0e2651a9c58ab6ed5";
